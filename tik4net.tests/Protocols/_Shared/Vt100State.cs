// Vt100State.cs — Minimal VT100 cursor state machine
// Answers RouterOS terminal dimension probes (ESC[6n / ESC[?...h/l).
...
{
    /// <summary>
    /// Minimal VT100 state machine used to answer RouterOS terminal dimension probes.
    /// Tracks cursor position (Row, Col) so ESC[6n (DSR) replies contain real coordinates.
    /// </summary>
    internal sealed class Vt100State
    {
        ...
        // Process incoming server text; return list of reply strings to send back.
