namespace tik4net
{
    ...
    public enum TikConnectionType
    {
        ...
        ApiSsl,
        /// <summary>
        /// MikroTik REST API over HTTP (port 80). Requires RouterOS 7.1+. Listen is supported by polling;
        /// Streaming is not (stateless HTTP holds no command exchange open), and neither is Safe Mode.
        /// </summary>
        Rest,
        /// <summary>
        ...
        /// Listen and Safe Mode are supported (Listen by polling); Streaming is not.
        ...
        /// This is the terminal-driven WinBox mode; see <see cref="WinboxNative"/> for the structured M2 mode
        /// and <see cref="WinboxCliMac"/> for the MAC-layer carrier.
        /// </summary>
        WinboxCli,
        /// <summary>
