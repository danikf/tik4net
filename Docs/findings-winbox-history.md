...
on demand over TCP too, where the same defect ends the session at once instead of stalling it. It was
present in 4.0.0 as shipped, and was fixed in `WinboxTcpTransport.ReadChunkedFrame` /
`TryTakeChunkedFrame`.
