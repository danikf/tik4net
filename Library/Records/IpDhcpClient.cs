...
namespace InvertedTomato.TikLink.Records {
    ...
    public class IpDhcpClient : SetRecordBase {
		...
		/// </summary>
		[RosProperty("add-default-route")]
        public AddDefaultRouteType AddDefaultRoute { get; set; } = AddDefaultRouteType.Yes;
        ...
        /// </summary>
        [RosProperty("use-peer-dns")]
        public bool UsePeerDns { get; set; } = true;
        ...
        /// </summary>
        [RosProperty("use-peer-ntp")]
        public bool UsePeerNtp { get; set; } = true;
