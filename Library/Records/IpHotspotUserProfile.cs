...
namespace InvertedTomato.TikLink.Records {
    ...
    public class IpHotspotUserProfile : SetRecordBase {
        ...
        /// </summary>
        [RosProperty("add-mac-cookie")]
        public bool AddMacCookie { get; set; } = true;
        ...
        /// </summary>
        [RosProperty("advertise-interval")]
        ...
        /// </summary>
        [RosProperty("idle-timeout", UnsetOnDefault = true)]
        public string/*time | none*/ IdleTimeout { get; set; } = "none";
        ...
        /// </summary>
        [RosProperty("mac-cookie-timeout", UnsetOnDefault = true)]
        public string/*time*/ MacCookieTimeout { get; set; } = "3d";
        ...
        /// </summary>
        [RosProperty("open-status-page")]
        public string/*always | http-login*/ OpenStatusPage { get; set; } = "always";
