...
namespace InvertedTomato.TikLink.Records {
    ...
    public class InterfaceWireless : ISetRecord {
        ...
        /// </summary>
        [RosProperty("station-bridge-clone-mac")]
        ...
        /// </summary>
        [RosProperty("supported-rates-a/g")]
        ...
        /// </summary>
        [RosProperty("tdma-override-size")]
        ...
        /// </summary>
        [RosProperty("update-stats-interval")]
