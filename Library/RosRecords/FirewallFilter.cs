...
namespace InvertedTomato.TikLink.RosRecords {
    ...
    public class FirewallFilter : IHasId {
        ...
        /// </summary>
        [RosProperty("action", typeof(RosEnumeration), IsRequired = true, DefaultValue = "accept")]
        ...
        /// </summary>
        [RosProperty("address-list", typeof(RosString))]
        ...
        /// </summary>
        [RosProperty("address-list-timeout", typeof(RosString), DefaultValue = "00:00:00")] // TODO: Not correct RosDataType
        ...
        /// </summary>
        [RosProperty("connection-bytes", typeof(RosString))]
        ...
        /// </summary>
        [RosProperty("connection-limit", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("connection-mark", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("connection-rate", typeof(RosString))]
        ...
        /// </summary>
        [RosProperty("connection-state", typeof(RosEnumeration), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("connection-type", typeof(RosString), UnsetOnDefault = true)]
        public string ConnectionType { get; set; }

        /// <summary>
        /// content: Match packets that contain specified text
        /// </summary>
        [RosProperty("content", typeof(RosString), UnsetOnDefault = true)]
        public string Content { get; set; }

        /// <summary>
        /// dscp: Matches DSCP IP header field.
        /// </summary>
        [RosProperty("dscp", typeof(RosInteger), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("dst-address", typeof(RosString), UnsetOnDefault = true)]
        public string DstAddress { get; set; }

        /// <summary>
        /// dst-address-list: Matches destination address of a packet against user-defined address list
        /// </summary>
        [RosProperty("dst-address-list", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("dst-address-type", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("dst-limit", typeof(RosString), UnsetOnDefault = true)]
        public string DstLimit { get; set; }

        /// <summary>
        /// dst-port: List of destination port numbers or port number ranges
        /// </summary>
        [RosProperty("dst-port", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("fragment", typeof(RosBoolean), UnsetOnDefault = true)]
        public bool? Fragment { get; set; }

        /// <summary>
        /// hotspot: 
        /// </summary>
        [RosProperty("hotspot", typeof(RosString), UnsetOnDefault = true)]
        public string Hotspot { get; set; }

        /// <summary>
        /// icmp-options: Matches ICMP type:code fileds
        /// </summary>
        [RosProperty("icmp-options", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("in-bridge-port", typeof(RosString), UnsetOnDefault = true)]
        public string/*name*/ InBridgePort { get; set; }

        /// <summary>
        /// in-interface: Interface the packet has entered the router
        /// </summary>
        [RosProperty("in-interface", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("ingress-priority", typeof(RosInteger), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("limit", typeof(RosString), UnsetOnDefault = true)]
        public string Limit { get; set; }

        /// <summary>
        /// log-prefix: Adds specified text at the beginning of every log message. Applicable if action=log
        /// </summary>
        [RosProperty("log-prefix", typeof(RosString))]
        public string LogPrefix { get; set; }

        /// <summary>
        /// nth: Matches every nth packet.  Read more &gt;&gt;
        /// </summary>
        [RosProperty("nth", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("out-bridge-port", typeof(RosString), UnsetOnDefault = true)]
        public string/*name*/ OutBridgePort { get; set; }

        /// <summary>
        /// out-interface: Interface the packet is leaving the router
        /// </summary>
        [RosProperty("out-interface", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("p2p", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("packet-mark", typeof(RosString), UnsetOnDefault = true)]
        public string PacketMark { get; set; }

        /// <summary>
        /// packet-size: Matches packets of specified size or size range in bytes.
        /// </summary>
        [RosProperty("packet-size", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("per-connection-classifier", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("port", typeof(RosString), UnsetOnDefault = true)]
        public string Port { get; set; }

        /// <summary>
        /// protocol: Matches particular IP protocol specified by protocol name or number
        /// </summary>
        [RosProperty("protocol", typeof(RosString), DefaultValue = "tcp", UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("src-address", typeof(RosString), UnsetOnDefault = true)]
        public string SrcAddress { get; set; }

        /// <summary>
        /// src-address-list: Matches source address of a packet against user-defined  address list
        /// </summary>
        [RosProperty("src-address-list", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// multicast - packet is forwarded to defined group of devices
        /// </summary>
        [RosProperty("src-address-type", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("src-port", typeof(RosString), UnsetOnDefault = true)]
        public string SrcPort { get; set; }

        /// <summary>
        /// src-mac-address: Matches source MAC address of the packet
        /// </summary>
        [RosProperty("src-mac-address", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// urg - urgent data
        /// </summary>
        [RosProperty("tcp-flags", typeof(RosString), UnsetOnDefault = true)]
        public string TcpFlags { get; set; }

        /// <summary>
        /// tcp-mss: Matches TCP MSS value of an IP packet
        /// </summary>
        [RosProperty("tcp-mss", typeof(RosString), UnsetOnDefault = true)]
        ...
        /// </summary>
        [RosProperty("time", typeof(RosString), UnsetOnDefault = true)]
        public string Time { get; set; }

        /// <summary>
        /// ttl: Matches packets TTL value
        /// </summary>
        [RosProperty("ttl", typeof(RosString), UnsetOnDefault = true)]
        public string Ttl { get; set; }

        /// <summary>
        /// Row disabled property.
        /// </summary>
        [RosProperty("disabled", typeof(RosBoolean), IsRequired = true)]
