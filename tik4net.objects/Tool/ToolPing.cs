...
namespace tik4net.Objects.Tool
{
    ...
    /// Author: seho85
    /// </summary>
    [TikEntity("/ping", LoadCommand ="", LoadDefaultParameterFormat = TikCommandParameterFormat.NameValue, SupportedOperations = TikEntityOperations.None, IncludeProplist = false)]
