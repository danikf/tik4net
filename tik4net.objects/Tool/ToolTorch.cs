...
namespace tik4net.Objects.Tool
{
    ...
    /// </summary>
    [TikEntity("/tool/torch", LoadCommand = "", LoadDefaultParameterFormat = TikCommandParameterFormat.NameValue, SupportedOperations = TikEntityOperations.None, IncludeProplist = false)]
