...
namespace tik4net.Objects.Ip
{
    ...
    public class IpService
    {
        ...
        /// </summary>
        /// <remarks>
        /// RouterOS 7 prints this field as <c>available-from</c> and RouterOS 6 as <c>address</c>; it is read
        /// under whichever the router prints. Written as <c>address</c>, which RouterOS 7 still accepts
