...
namespace tik4net.Objects.Interface.Tunnel
{
    /// <summary>
    /// /interface/gre
    /// GRE (Generic Routing Encapsulation) is a tunneling protocol that encapsulates a wide
    /// variety of protocols, creating a virtual point-to-point link between two routers.
    /// Adds 24 bytes of overhead per packet.
    /// See https://help.mikrotik.com/docs/display/ROS/GRE
    /// </summary>
    [TikEntity("/interface/gre", IncludeDetails = true)]
    public class InterfaceGre
    {
