...
namespace tik4net.integrationtests
{
    ...
    /// <para>Those figures are also an <i>unloaded</i> router's. Sustained traffic — from any connection,
    /// the ceiling is aggregate — clamps a ~1 ms round trip to ~20 ms and worse, until the load stops, so
